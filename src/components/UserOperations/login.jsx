...
function Login(){
    ...
    return (
        <>
        {error && (
            <BannerComp content="User with the credentails doesn't exist" border="border-red-500" textcolor="text-red-600" bgcolor="bg-red-100" onClose={OnBannerClose}/>
        )}
      ...
      <form onSubmit={HandleSubmitForm} className="flex flex-col gap-10 justify-center">
        <div className="flex flex-col gap-3">
           ...
           <p className="text-white font-light text-xl leading-10">Don't have an account ? <Link to="/register" className="rounded-lg text-gray-300 w-fit ml-auto mr-auto font-semibold">Create</Link></p>
