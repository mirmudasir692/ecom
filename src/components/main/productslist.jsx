...
function CategoryProducts({ category }) {
  ...
  return (
    <>
      <h1 className="text-start text-3xl font-extrabold pb-8">
        {category.name}
      </h1>
        ...
        <div className="ml-10 mt-auto mb-auto">
          {hasNext && (
            <Link
              ...
              className="text-xl font-bold bg-slate-500 px-6 py-3 rounded-lg text-white hover:bg-gray-400 hover:text-black"
            >
              More
            </Link>
          )}
